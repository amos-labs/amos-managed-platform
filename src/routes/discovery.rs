...
fn find_suggestions(requested: &str) -> Vec<String> {
    ...
    let known_paths: Vec<(&str, &str)> = vec![
        ...
        (
            "api/v1/token/calculate-decay",
            "POST /api/v1/token/calculate-decay",
        ),
        (
            "api/v1/token/revenue-split",
            "POST /api/v1/token/revenue-split",
        ),
        (
            "api/v1/governance/proposals",
            "GET|POST /api/v1/governance/proposals",
        ),
        (
        ...
        (
            "api/v1/governance/proposals/{id}/gates",
            "GET /api/v1/governance/proposals/{id}/gates",
        ),
        (
        ...
        (
            "api/v1/billing/customers/{id}/usage",
            "GET /api/v1/billing/customers/{id}/usage",
        ),
        (
            "api/v1/billing/customers/{id}/subscribe",
            "POST /api/v1/billing/customers/{id}/subscribe",
        ),
        ...
        (
            "api/v1/provision/harness/{id}",
            "GET|DELETE /api/v1/provision/harness/{id}",
        ),
        (
            "api/v1/provision/harness/{id}/start",
            "POST /api/v1/provision/harness/{id}/start",
        ),
        (
            "api/v1/provision/harness/{id}/stop",
            "POST /api/v1/provision/harness/{id}/stop",
        ),
        (
            "api/v1/provision/harness/{id}/logs",
            "GET /api/v1/provision/harness/{id}/logs",
        ),
